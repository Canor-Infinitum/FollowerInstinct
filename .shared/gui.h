...
#ifndef INFINITUM_GUI_H
#define INFINITUM_GUI_H
...
INF_API void gui_element_init(struct gui_element_t *element, uint32_t kind, gui_id_t id);
INF_API void gui_document_init(struct gui_document_t *document);
INF_API int gui_document_reserve(struct gui_document_t *document, uint64_t element_count);
INF_API void gui_document_free(struct gui_document_t *document);
